...
: ${AMENT_CURRENT_PREFIX:="/media/lee/other/gitText/install/git_test"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/git_test/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/git_test/environment/path.sh"
